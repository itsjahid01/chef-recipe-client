  ...
  return (
    <div className="container mx-auto">
      <div className="w-9/12 mx-auto p-5">
        ...
        <p>
          <span className="text-lg font-semibold text-green-500">Ans: </span>In
          React, controlled components refer to components that have their state
          ...
          and behavior. Uncontrolled components refer to components that manage
        ...
        <p>
          <span className="text-lg font-semibold text-green-500">Ans: </span>JS
          web application framework that provides a robust set of features for
          web and mobile applications. In other words, NodeJS is the package,
          which provides the JavaScript run-time environment, whereas Express is
          a framework that sits on top of NodeJS and helps us to handle requests
          and responses.
        </p>
        <br />
        <p className="text-lg font-semibold ">
